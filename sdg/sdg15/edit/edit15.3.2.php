...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO tbl15_3_1_number ( title, description, cost, fund) 
...
============================================================================================= -->
  ...
  <div class="main">
    ...
    <div class="input-container">
      ...
      $query = "SELECT Count(*) AS total FROM tbl15_3_"; // SQL query to fetch all table data
  ...
  <div class="table-container">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        $query = "SELECT * FROM tbl15_3_ORDER BY ID DESC"; // SQL query to fetch all table data
        $result = mysqli_query($conn, $query); // sending the query to the database

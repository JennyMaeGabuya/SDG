...
if (isset($_GET['delete'])) {
    ...
    if (isset($_GET['confirm']) && $_GET['confirm'] == 'true') {
        ...
        $query = "DELETE FROM `tbl433_vocational` WHERE `total_number` = {$deleteid}";
        ...
        echo "<script>
              ...
              if (confirmed) {
                  window.location.href = 'delete4.3.3.php?delete=$deleteid&confirm=true';
              } else {
                  window.location.href = '4.3.3.php';
              }
              </script>";
    }
}

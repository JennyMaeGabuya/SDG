...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl15_43_ecosystem` ( `title`, `description`, `cost`, `fund`) 
...
<title>SDG 15.4.3 | Maintain and extend current ecosystems’ biodiversity</title>
...
.table-container {
  ...
  margin: 60px auto; /* Center the table and provide space */
...
<div class="main">
  ...
  <div class="input-container">
    ...
    <?php
            ...
            $query = "SELECT Count(*) AS total FROM `tbl15_43_ecosystem`"; // SQL query to fetch all table data
...
<!--============================================================================================= 
 ...
 ============================================================================================= -->
  ...
  <div class="content">
    <br>
    <h3 class="text-center">15.4.3 Maintain and extend current ecosystems’ biodiversity</h3>
     <p>Work directly to maintain and extend existing ecosystems and their 
biodiversity, <br>of both plants and animals, especially ecosystems under 
threat</p>       
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th> -->
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
      <th scope="col"colspan="2" class ="text-center" style="width: 04px;">Action</th>
    </tr>
  </thead>
    <tbody>
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl15_43_ecosystem`ORDER BY `ID` DESC"; // SQL query to fetch all table data
            $result = mysqli_query($conn, $query); // sending the query to the database
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td class ='text-center' style='width:100px'>
                          <a href='edit/edit15.4.3.php?update&ppa_id={$id}' style='width:30px;'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete15.4.3.php?delete={$id}' style='width:30px;color:red;'>

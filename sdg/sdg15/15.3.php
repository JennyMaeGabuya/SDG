...
<!--============================================================================================= 
 ...
 ============================================================================================= -->
  ...
  <div class="content">
    <br>
    <h3>15.3 Proportion of endangered flora and fauna in the campus</h3>
...
<div class="table-container">
  <h2>Measures to conserve the endangered species</h2>           
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td class ='text-center' style='width:100px'>
                          <a href='edit/edit15.3.php?update&ppa_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete15.3.php?delete={$id}' class='btn btn-danger'>

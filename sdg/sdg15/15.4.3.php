...
<!--============================================================================================= 
 ...
 ============================================================================================= -->
  ...
  <div class="content">
    <br>
    <h3>15.4.3 Maintain and extend current ecosystems’ biodiversity</h3>
     <p>Work directly to maintain and extend existing ecosystems and their 
biodiversity, of both plants and animals, <br>especially ecosystems under 
threat</p>       
  </div>
   <!--============================================================================================= 
                                  START OF FORM
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td class ='text-center' style='width:100px'>
                          <a href='edit/edit15.4.3.php?update&ppa_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete15.4.3.php?delete={$id}' class='btn btn-danger'>

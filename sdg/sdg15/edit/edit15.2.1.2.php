...
$id = $totalEmployees = $maleGardening = $femaleGardening = $maleVertical = $femaleVertical = '';

if (isset($_GET['empid'])) {
    // Sanitize the input to prevent SQL injection
    $id = mysqli_real_escape_string($conn, $_GET['empid']);
    $query = "SELECT * FROM `tbl15_2_employee` WHERE `ID` = '$id'";
...
if (isset($_POST['update'])) {
    ...
    $totalEmployees = mysqli_real_escape_string($conn, $_POST['totalEmployees']);
    ...
    $query = "UPDATE `tbl15_2_employee` SET `total_employees` = '$totalEmployees', `emp_mgardening` = '$maleGardening', `emp_fgardening` = '$femaleGardening', `emp_mvertical` = '$maleVertical', `emp_fvertical` = '$femaleVertical' WHERE `ID`= '$id'";
...
============================================================================================= -->
    <div class="card">
        <form method="POST">
            ...
            <input type="number" class="form-control" name="totalEmployees" required value="<?php echo htmlspecialchars($totalEmployees); ?>">
        </div>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="maleSpaceForGardening" required value="<?php echo htmlspecialchars($maleGardening); ?>">
            </div>

            <div class="form-group">
                <label>Female employees with available space for gardening</label>
                <input type="number" class="form-control" name="femaleSpaceForGardening" required value="<?php echo htmlspecialchars($femaleGardening); ?>">
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="maleSpaceForVerticalGardening" required value="<?php echo htmlspecialchars($maleVertical); ?>">
            </div>

            <div class="form-group">
                <label>Female employees with available space for vertical gardening</label>
                <input type="number" class="form-control" name="femaleSpaceForVerticalGardening" required value="<?php echo htmlspecialchars($femaleVertical); ?>">
            </div>
        </fieldset>
        ...
        button: 'OK'
            ...
            <button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../15.2.1.2.php';">

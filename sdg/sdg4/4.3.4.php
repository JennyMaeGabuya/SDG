...
<body>
  ...
  <div class="content">
    <br>
    <h3>4.3.4 Educational outreach activities beyond campus (extension activities)</h3>
    <p>Undertake educational outreach activities</p>
      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<td style='width:100px'>
                          <a href='edit_4.3.4.php?update&outreach_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_4.3.4.php?delete={$id}' class='btn btn-danger'>

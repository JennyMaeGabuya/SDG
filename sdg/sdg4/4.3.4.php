...
============================================================================================= -->
 ...
 ============================================================================================= -->
  ...
  <div class="content">
    <br>
    <h3 class=" text-center">4.3.4 Educational outreach activities beyond campus (extension activities)</h3>
    <p class="text-center">Undertake educational outreach activities</p>
...
============================================================================================= -->
  <div class="table-container">
    <h2 class="text-center" >Outreach Activities</h2>
      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<td class ='text-center' style='width:100px'>
                          <a href='edit/edit_4.3.4.php?update&outreach_id={$id}' style='width:45px;'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_4.3.4.php?delete={$id}' style='width:45px;color:red;'>

...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO tbl15_3_2_endangered ( title, description, cost, fund) 
...
<head>
  ...
  <title>SDG 15.3.2 | Endangered species </title>
...
============================================================================================= -->
  ...
  <div class="main">
    ...
    <div class="input-container">
      ...
      $query = "SELECT Count(*) AS total FROM tbl15_3_2_endangered"; // SQL query to fetch all table data
...
<!--============================================================================================= 
 ...
 ============================================================================================= -->
  ...
  <div class="content">
    <br>
    <h3>15.3.2 Endangered species</h3>
    <p>Have conservation measures for endangered species in the campus.</p>
  ...
  <div class="table-container">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        $query = "SELECT * FROM tbl15_3_2_endangered ORDER BY ID DESC"; // SQL query to fetch all table data
        $result = mysqli_query($conn, $query); // sending the query to the database
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<td style='width:100px'>
                          <a href='edit/edit_15.3.2.php?update&event_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete_15.3.2.php?delete={$id}' class='btn btn-danger'>

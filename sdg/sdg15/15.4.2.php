...
<!--============================================================================================= 
 ...
 ============================================================================================= -->
  ...
  <div class="content">
    <br>
    <h3>15.4.2 Sustainably farmed food on campus</h3>
...
<div class="table-container">
  <h2>Sustainably farmed food on campus</h2>           
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td class ='text-center' style='width:100px'>
                          <a href='edit/edit15.4.2.php?update&ppa_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete15.4.2.php?delete={$id}' class='btn btn-danger'>
